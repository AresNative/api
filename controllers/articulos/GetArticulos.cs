...
namespace MyApiProject.Controllers
{
    ...
    {
        public Articulos(IConfiguration configuration) : base(configuration) { }
        public class ArticulosRequest
        {
            public List<BusquedaParams> Filtros { get; set; } = new();
        }

        [HttpPost("api/v2/select/articulos")]
        public async Task<IActionResult> ObtenerArticulosRequest(
            [FromBody] ArticulosRequest request,
