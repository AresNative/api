...
namespace MyApiProject.Controllers
{
    ...
    {
        public Combo(IConfiguration configuration) : base(configuration) { }
        public class ComboRequest
        {
            public List<BusquedaParams> Filtros { get; set; } = new();
        }

        [HttpPost("api/v2/select/combo")]
        public async Task<IActionResult> ObtenerComboRequest(
            [FromBody] ComboRequest request,
