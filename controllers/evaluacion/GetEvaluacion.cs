...
namespace MyApiProject.Controllers
{
    ...
    {
        public Evaluacion(IConfiguration configuration) : base(configuration) { }
        public class EvaluacionRequest
        {
            public List<BusquedaParams> Filtros { get; set; } = new();
        }

        [HttpPost("api/v2/select/Evaluacion")]
        public async Task<IActionResult> ObtenerEvaluacionRequest(
            [FromBody] EvaluacionRequest request,
            ...
            [FromQuery] int pageSize = 10)
        {
            ...
            var baseQuery = @"
            FROM [LOCAL_TC032391E].[dbo].[Website_Evaluacion]";
