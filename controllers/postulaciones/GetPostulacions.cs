...
namespace MyApiProject.Controllers
{
    ...
    {
        public Postulaciones(IConfiguration configuration) : base(configuration) { }
        public class PostulacionesRequest
        {
            public List<BusquedaParams> Filtros { get; set; } = new();
        }

        [HttpPost("api/v2/select/postulaciones")]
        public async Task<IActionResult> ObtenerPostulacionesRequest(
            [FromBody] PostulacionesRequest request,
