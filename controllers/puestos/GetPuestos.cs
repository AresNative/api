...
namespace MyApiProject.Controllers
{
    ...
    {
        public Puestos(IConfiguration configuration) : base(configuration) { }
        public class PuestosRequest
        {
            public List<BusquedaParams> Filtros { get; set; } = new();
        }

        [HttpPost("api/v2/select/puestos")]
        public async Task<IActionResult> ObtenerPuestosRequest(
            [FromBody] PuestosRequest request,
            ...
            [FromQuery] int pageSize = 10)
        {
            ...
            var baseQuery = @"
            FROM [LOCAL_TC032391E].[dbo].[Website_puestos]";
