...
namespace MyApiProject.Controllers
{
    public partial class Usuarios : BaseController
    {
        ...
        [HttpPost("api/v2/select/Usuarios")]
        public async Task<IActionResult> ObtenerUsuariosRequest(
            [FromBody] UsuariosRequest request,
            ...
            [FromQuery] int pageSize = 10)
        {
            ...
            var baseQuery = @"
            FROM [LOCAL_TC032391E].[dbo].[Website_users]";
